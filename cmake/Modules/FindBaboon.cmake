...
FIND_PATH( Baboon_INCLUDE_DIRS
  ...
  HINTS "/home/remi/ilcsoft/SDHCAL/Baboon"
  NO_DEFAULT_PATH
)

IF( NOT Baboon_INCLUDE_DIRS AND NOT Baboon_FIND_QUIETLY )
    MESSAGE( STATUS "Check for Baboon: /home/remi/ilcsoft/SDHCAL/Baboon"
...
FIND_LIBRARY( Baboon_LIBRARY
    NAMES Baboon
    PATHS "/home/remi/ilcsoft/SDHCAL/Baboon"
    PATH_SUFFIXES lib
    NO_DEFAULT_PATH )
...
IF( Baboon_INCLUDE_DIRS AND Baboon_LIBRARY )
    ...
    MESSAGE( STATUS "Check for Baboon: /home/remi/ilcsoft/SDHCAL/Baboon -- works" )
ELSE()
    IF( Baboon_FIND_REQUIRED )
        MESSAGE( FATAL_ERROR "Check for Baboon: /home/remi/ilcsoft/SDHCAL/Baboon -- failed!!" )
    ENDIF()
    MESSAGE( STATUS "Check for Baboon: /home/remi/ilcsoft/SDHCAL/Baboon"
